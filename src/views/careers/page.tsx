...
import { ArrowRight, CheckCircle, AlertCircle, Loader2, Code2, Brain, MonitorPlay, PenTool, TrendingUp, Server, HeartPulse, Clock, Globe2, BookOpen, Plane, Paperclip } from 'lucide-react';
...
export default function CareersPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      submitData.append('requirement', `Job Application — ${form.role}`);
      submitData.append('message', `Experience: ${form.experience}\nPortfolio/LinkedIn: ${form.link}\n\nMessage:\n${form.message}`);
